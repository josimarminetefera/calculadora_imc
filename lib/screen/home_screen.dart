        ...
        child: Form( //formulario
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Icon(Icons.person_outline, size: 120, color: Colors.purpleAccent,),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(//adicionar decoração ao campo
                ...
                validator: (valor){ //valor do meu campo digitado
                  if(valor.isEmpty){
